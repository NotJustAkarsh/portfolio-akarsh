...
const TechMarquee = () => (
  <div className="w-full overflow-hidden py-14 mb-32 border-y border-zinc-100 dark:border-zinc-900 bg-zinc-50/30 dark:bg-zinc-900/10">
    <div className="animate-marquee whitespace-nowrap">
      {[...MARQUEE_STACK, ...MARQUEE_STACK, ...MARQUEE_STACK].map((tech, i) => (
