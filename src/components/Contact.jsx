...
const Contact = () => (
  <section id="about" className="relative group">
    ...
    <div className="relative rounded-[4rem] p-8 md:p-24 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-center overflow-hidden shadow-2xl">
       ...
       <a 
         ...
         className="inline-flex flex-wrap justify-center items-center break-all md:break-normal gap-2 md:gap-4 text-xl sm:text-2xl md:text-5xl font-black tracking-tighter hover:text-blue-500 transition-all border-b-4 border-blue-500 pb-2 hover:gap-4 md:hover:gap-8"
       >
         notjustakarsh@gmail.com <ChevronRight className="w-8 h-8 md:w-12 md:h-12 shrink-0" />
       </a>
    </div>
  </section>
);
